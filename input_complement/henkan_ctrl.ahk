...
;   ToolTip  ;Turn off the tip.
  ;Input, SandS_AnyKey, L1 V M,{RWin}{AppsKey}A{F1}{F2}{F3}{F4}{F5}{F6}{F7}{F8}{F9}{F10}{F11}{F12}{Left}{Right}{Up}{Down}{Home}{End}{PgUp}{PgDn}{Del}{Ins}{BS}{Capslock}{Numlock}{PrintScreen}{Pause}   SandS_AnyKeyPressed := 1
  ; ctrlは画面出力を行なわない
  ; そのためShiftとは動作が異なる
